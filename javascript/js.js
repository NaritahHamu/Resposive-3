...
function servicesSelect(data){
  ...
  switch (data) {
      case 'BCS':
        ...
        $(".services-img:nth-child(1)").css("background-image","url('images/go-cabling.png')")
        $(".services-img:nth-child(2)").css("background-image","url('images/go-cabling.png')")
        $(".services-img:nth-child(3)").css("background-image","url('images/go-cabling.png')")
        $(".services-img:nth-child(4)").css("background-image","url('images/go-cabling.png')")
      ...
      case 'FMS':
        ...
        $(".services-img:nth-child(1)").css("background-image","url('images/mobile-antenna.png')")
        $(".services-img:nth-child(2)").css("background-image","url('images/mobile-antenna.png')")
        $(".services-img:nth-child(3)").css("background-image","url('images/mobile-antenna.png')")
        $(".services-img:nth-child(4)").css("background-image","url('images/mobile-antenna.png')")
      ...
      case 'FTTH':
        ...
        $(".services-img:nth-child(1)").css("background-image","url('images/solar-panels.png')")
        $(".services-img:nth-child(2)").css("background-image","url('images/solar-panels.png')")
        $(".services-img:nth-child(3)").css("background-image","url('images/solar-panels.png')")
        $(".services-img:nth-child(4)").css("background-image","url('images/solar-panels.png')")
      ...
      case 'LPS':
        ...
        $(".services-img:nth-child(1)").css("background-image","url('images/IMG_1708.jpg')")
        $(".services-img:nth-child(2)").css("background-image","url('images/IMG_1708.jpg')")
        $(".services-img:nth-child(3)").css("background-image","url('images/IMG_1708.jpg')")
        $(".services-img:nth-child(4)").css("background-image","url('images/IMG_1708.jpg')")
